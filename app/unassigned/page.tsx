...
export default async function Unassigned({ searchParams }: { searchParams: Promise<{ code?: string }> }) {
	...
	return <main className="flex min-h-screen items-center justify-center bg-[var(--paper)] px-6">
		<div className="max-w-md text-center">
			...
			<p className="text-[var(--muted)]">This QR code does not have a Google Maps review link yet.</p>
